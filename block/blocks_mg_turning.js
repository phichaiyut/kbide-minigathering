module.exports = function(Blockly){
  ...
  zeroArgBlock('mg_spin_left', "หมุนซ้ายจนกว่าจะเจอเส้น (SpinL)", "SpinL() — Spins in place to the left until the line is detected (set spin speed first).\n\nภาษาไทย: หมุนอยู่กับที่ไปทางซ้ายจนกว่าจะเจอเส้น (ตั้งความเร็วหมุนก่อน)");
  zeroArgBlock('mg_spin_left2', "หมุนซ้ายจนกว่าจะเจอเส้น 2 (SpinL2)", "SpinL2() — Spins in place to the left using a second timing pattern (set spin speed first).\n\nภาษาไทย: หมุนอยู่กับที่ไปทางซ้ายด้วยจังหวะเวลาแบบที่สอง (ตั้งความเร็วหมุนก่อน)");
  zeroArgBlock('mg_spin_right', "หมุนขวาจนกว่าจะเจอเส้น (SpinR)", "SpinR() — Spins in place to the right until the line is detected (set spin speed first).\n\nภาษาไทย: หมุนอยู่กับที่ไปทางขวาจนกว่าจะเจอเส้น (ตั้งความเร็วหมุนก่อน)");
  zeroArgBlock('mg_spin_right2', "หมุนขวาจนกว่าจะเจอเส้น 2 (SpinR2)", "SpinR2() — Spins in place to the right using a second timing pattern (set spin speed first).\n\nภาษาไทย: หมุนอยู่กับที่ไปทางขวาด้วยจังหวะเวลาแบบที่สอง (ตั้งความเร็วหมุนก่อน)");
};
